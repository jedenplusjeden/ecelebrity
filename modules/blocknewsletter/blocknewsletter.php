...
class Blocknewsletter extends Module
{
	 ...
	 */
	 ...
	 public function do_post_request2($url, $data)
		{
    	$ch = curl_init($url);
	...
	protected function registerUser($email)
	{
		...
		$clientId = 'g3n3kujta5nkphpn'; 
		$endpoint = 'app2.salesmanago.pl'; 
    	$apiKey = 'j2q8qp4fbp9qf2b8p49fb';
		$owner = 'skrolikowski@conhpolbis.com';
    	$apiSecret = '6ajyuh1o2r32jrqidt5lwso60pmgkxge';
		$data = array(
        		'clientId' => $clientId,
        		'apiKey' => $apiKey,
        		'requestTime' => time(),
    	...
    	$result2 = $this->do_post_request2('http://' . $endpoint . '/api/contact/upsert', $json2); 
		...
		$result7 = $this->do_post_request2('http://' . $endpoint . '/api/contact/addContactExtEvent', $json7);
