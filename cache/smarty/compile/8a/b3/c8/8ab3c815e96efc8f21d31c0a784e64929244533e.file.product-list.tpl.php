<?php /* Smarty version Smarty-3.1.19, created on 2014-11-06 11:50:33
         compiled from "/var/www/vhosts/ecelebrity.eu/httpdocs/themes/default-bootstrap/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2933555715452342671c456-62174542%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2933555715452342671c456-62174542',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_54523426a90b38_89858828',
  'variables' => 
  array (
    'products' => 0,
    'page_name' => 0,
...
<?php if ($_valid && !is_callable('content_54523426a90b38_89858828')) {function content_54523426a90b38_89858828($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/vhosts/ecelebrity.eu/httpdocs/tools/smarty/plugins/function.math.php';
?>
...
" itemprop="url" >
                    ...
                    <div class="list-product-additional-info">
                        <?php if (!empty($_smarty_tpl->tpl_vars['product']->value['reference'])&&$_smarty_tpl->tpl_vars['product']->value['reference']) {?>
                            <p><?php echo $_smarty_tpl->tpl_vars['product']->value['reference'];?>
</p>
                        <?php }?>
...
?>
                            <?php if ($_smarty_tpl->tpl_vars['feature']->value['name']=='Kolor') {?>
                                <p>col. <?php echo $_smarty_tpl->tpl_vars['feature']->value['value'];?>
</p>
                            <?php }?>
                        <?php } ?>
                    </div>
