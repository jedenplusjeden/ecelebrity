<?php /* Smarty version Smarty-3.1.19, created on 2014-11-06 11:46:48
         compiled from "/var/www/vhosts/ecelebrity.eu/httpdocs/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8195132515452342b111819-37328248%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c26c71310306079951f1c3cc2decbceafc03244c' => 
    array (
      0 => '/var/www/vhosts/ecelebrity.eu/httpdocs/themes/default-bootstrap/product.tpl',
      1 => 1415269682,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8195132515452342b111819-37328248',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5452342ba082b9_65479566',
  'variables' => 
  array (
    'errors' => 0,
...
<?php if ($_valid && !is_callable('content_5452342ba082b9_65479566')) {function content_5452342ba082b9_65479566($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/var/www/vhosts/ecelebrity.eu/httpdocs/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/ecelebrity.eu/httpdocs/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/vhosts/ecelebrity.eu/httpdocs/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/var/www/vhosts/ecelebrity.eu/httpdocs/tools/smarty/plugins/function.counter.php';
?>
...
"/>
							<?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?>
                            <span class="span_link no-print" data-number="0"><?php echo smartyTranslate(array('s'=>'View larger'),$_smarty_tpl);?>
</span>
                        <?php }?>
                        <?php }?>
					</span>
...
" name="resetImages">
        ...
        <div class="pb-center-column col-xs-12 col-sm-4">
            ...
            <?php }?>
            <h1 itemprop="name">
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->category, ENT_QUOTES, 'UTF-8', true);?>
<br/>
                <small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</small>
            </h1>
...
" <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> <?php }?> />
...
" class="product-image product_image">
                                                <img class="lazyOwl" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'cart_default'), ENT_QUOTES, 'UTF-8', true);?>
                        ...
                        <div class="box-cart-bottom">
                            <div class="content_prices clearfix">
                                <?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
                                    <!-- prices -->
                                    <div class="cena-label">cena: </div>
                                    <div class="price">
                                        <p id="old_price"<?php if ((!$_smarty_tpl->tpl_vars['product']->value->specificPrice||!$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])&&$_smarty_tpl->tpl_vars['group_reduction']->value==0) {?> class="hidden"<?php } else { ?> class="vis"<?php }?>>
                            ...
                            <div>
                                <div id="add_to_cart" class="buttons_bottom_block no-print">
                                    ...
                                    <div class="fb-like-wrapper">
                                        <div class="fb-share-button" data-href="https://www.facebook.com/Celebrityfootwear"></div>
                                    </div>
                                </div>
                            </div>
