<?php /* Smarty version Smarty-3.1.19, created on 2014-10-30 15:51:09
         compiled from "/var/www/vhosts/ecelebrity.eu/httpdocs/themes/default-bootstrap/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:47667822154523ffed36580-91208858%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05fb66c7c333a4fa1165175a49637c5e33959948' => 
    array (
      0 => '/var/www/vhosts/ecelebrity.eu/httpdocs/themes/default-bootstrap/shopping-cart.tpl',
      1 => 1414680665,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '47667822154523ffed36580-91208858',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_54523fff4670f5_28433262',
  'variables' => 
  array (
    'empty' => 0,
    'PS_CATALOG_MODE' => 0,
...
<?php if ($_valid && !is_callable('content_54523fff4670f5_28433262')) {function content_54523fff4670f5_28433262($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/vhosts/ecelebrity.eu/httpdocs/tools/smarty/plugins/modifier.regex_replace.php';
?>
		...
		<table id="cart_summary" class="table table-bordered <?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>stock-management-on<?php } else { ?>stock-management-off<?php }?>">
			<thead>
				<tr>
					...
					<th class="cart_description item">Produkt</th>
					<th class="cart_quantity item">Ilość</th>
                    <th class="cart_unit item">Cena</th>
					<th class="cart_total item">Razem</th>
				</tr>
			</thead>
			<tfoot>
...
<?php }?>" />
                                    ...
                                    <p class="kupony-opis">Jeśli posiadasz kupon rabatowy - aktywuj go,<br/>a otrzymasz rabat cenowy.</p>
...
<br />
                    ...
                    <td colspan="2" class="cart-podsumowanie">
                        <?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
                            <?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
                                <?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><span class="label-suma">Suma</span><?php } else { ?><span class="label-suma">Suma</span><?php }?>
                                <span class="suma-koncowa"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</span>
                            <?php } else { ?>
                                <?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><span class="label-suma">Suma</span><?php } else { ?><span class="label-suma">Suma</span><?php }?>
                                <span class="suma-koncowa"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products_wt']->value),$_smarty_tpl);?>
</span>
                            <?php }?>
                        <?php } else { ?>
                            <span class="label-suma">Suma</span>
                            <span class="suma-koncowa"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</span>
                        <?php }?>

                        <div class="rest-cart-next">

                            <div<?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value==0) {?> style="display: none;"<?php }?>>
...
<?php }?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)) {?>
                                <div class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)) {?>display:none;<?php }?>">
                                    <div colspan="<?php echo $_smarty_tpl->tpl_vars['col_span_subtotal']->value;?>
" class="text-right"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</div>
                                    <div colspan="2" class="price" id="total_shipping"><?php echo smartyTranslate(array('s'=>'Free Shipping!'),$_smarty_tpl);?>
</div>
                                </div>
                            <?php } else { ?>
...
<?php }?></div>
                                            <div colspan="2" class="price" id="total_shipping"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
</div>
                                        </div>
                                    <?php } else { ?>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></div>
                                            <div colspan="2" class="price" id="total_shipping" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping']->value),$_smarty_tpl);?>
</div>
                                        </div>
                                    <?php }?>
                                <?php } else { ?>
...
" class="text-right"><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
                                    ...
                                    <div colspan="2" class="price" id="total_price_without_tax"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
</div>
                                </div>
...
" class="text-right"><?php echo smartyTranslate(array('s'=>'Total tax'),$_smarty_tpl);?>
                                    ...
                                    <div colspan="2" class="price" id="total_tax"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_tax']->value),$_smarty_tpl);?>
</div>
                                </div>
                            <?php }?>
                            <div class="cart_total_price">
...
<?php }?>
<!-- Google Code for Adwords - Odwiedziny koszyka Conversion Page -->
...
<script type="text/javascript">
    ...
    var google_conversion_label = "V5wiCM69m1cQh4nN0QM";
...
<noscript>
    ...
    <div style="display:inline;">
        ...
        <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/976438407/?label=V5wiCM69m1cQh4nN0QM&amp;guid=ON&amp;script=0"/>
