...
{if $errors|@count == 0}
	...
	<div class="primary_block row">
                ...
                <div id="image-block" class="clearfix">
                    ...
                    {if $have_image}
						...
						{else}
							...
							{if !$content_only}
                            <span class="span_link no-print" data-number="0">{l s='View larger'}</span>
                        {/if}
                        {/if}
					</span>
                    {else}
        ...
        <div class="pb-center-column col-xs-12 col-sm-4">
            ...
            {/if}
            <h1 itemprop="name">
                {$product->category|escape:'html':'UTF-8'}<br/>
                <small>{$product->name|escape:'html':'UTF-8'}</small>
            </h1>
                                                    ...
                                                    <div class="attribute_list">
                                                        ...
                                                        {elseif ($group.group_type == 'radio')}
                                                            <ul>
                                                                {foreach from=$group.attributes key=id_attribute item=group_attribute}
                                                                    <li>
                                                                        <input type="radio" class="attribute_radio" name="{$groupName|escape:'html':'UTF-8'}" value="{$id_attribute}" {if ($group.default == $id_attribute)} {/if} />
                                    ...
                                    {foreach from=$accessories item=accessory name=accessories_list}
                                        {if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
                                            ...
                                            <a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
                                                <img class="lazyOwl" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'cart_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}"/>
                                            </a>
                                        {/if}
                                    {/foreach}
                                </div>
                        ...
                        <div class="box-cart-bottom">
                            <div class="content_prices clearfix">
                                {if $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
                                    ...
                                    <div class="price">
                                        <p id="old_price"{if (!$product->specificPrice || !$product->specificPrice.reduction) && $group_reduction == 0} class="hidden"{else} class="vis"{/if}>
