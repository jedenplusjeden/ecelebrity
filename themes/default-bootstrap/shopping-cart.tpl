			...
			<tfoot>
                <tr class="cart_total_price">
                    ...
                    <td colspan="2" class="cart-podsumowanie">
                        {if $use_taxes}
                            {if $priceDisplay}
                                {if $display_tax_label}<span class="label-suma">Suma</span>{else}<span class="label-suma">Suma</span>{/if}
                                <span class="suma-koncowa">{displayPrice price=$total_products}</span>
                            {else}
                                {if $display_tax_label}<span class="label-suma">Suma</span>{else}<span class="label-suma">Suma</span>{/if}
                                <span class="suma-koncowa">{displayPrice price=$total_products_wt}</span>
                            {/if}
                        {else}
                        ...
                        <div class="rest-cart-next">
                            ...
                            {if $total_shipping_tax_exc <= 0 && !isset($virtualCart)}
                                <div class="cart_total_delivery" style="{if !isset($carrier->id) || is_null($carrier->id)}display:none;{/if}">
                                    <div colspan="{$col_span_subtotal}" class="text-right">{l s='Shipping'}</div>
                                    <div colspan="2" class="price" id="total_shipping">{l s='Free Shipping!'}</div>
                                </div>
                            {else}
                            ...
                            {if $use_taxes && $show_taxes}
                                <div class="cart_total_price">
                                    <div colspan="{$col_span_subtotal}" class="text-right">{l s='Total (tax excl.)'}</div>
                                ...
                                <div class="cart_total_tax">
                                    <div colspan="{$col_span_subtotal}" class="text-right">{l s='Total tax'}</div>
